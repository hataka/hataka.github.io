...
public class _CandlestickChartExample_Styles
{
    ...
    public static function init(fbs:IFlexModuleFactory):void
    {
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.series.CandlestickSeries", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.series.CandlestickSeries");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.CandlestickChart", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.CandlestickChart");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
