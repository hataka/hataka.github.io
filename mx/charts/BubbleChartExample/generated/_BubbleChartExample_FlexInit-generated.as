...
[Mixin]
public class _BubbleChartExample_FlexInit
{
   public function _BubbleChartExample_FlexInit()
   {
       super();
   }
   public static function init(fbs:IFlexModuleFactory):void
   {
       ...
       var styleNames:Array = ["paragraphStartIndent", "kerning", "breakOpportunity", "alternatingItemColors", "leading", "wordSpacing", "fontAntiAliasType", "markerWidth", "cffHinting", "contentBackgroundAlpha", "fontFamily", "itemSelectionColor", "markerHeight", "digitCase", "textSelectedColor", "clearFloats", "layoutDirection", "paragraphEndIndent", "ligatureLevel", "dropShadowColor", "shadowColor", "downColor", "fontWeight", "interactionMode", "dominantBaseline", "textAlign", "accentColor", "fontSharpness", "justificationStyle", "footerColors", "axisTitleStyleName", "headerColors", "whiteSpaceCollapse", "contentBackgroundColor", "textDecoration", "fontLookup", "fontStyle", "chromeColor", "digitWidth", "focusColor", "themeColor", "listAutoPadding", "blockProgression", "listStyleType", "fontSize", "textRollOverColor", "textAlignLast", "fontGridFitType", "trackingRight", "showErrorSkin", "errorColor", "paragraphSpaceAfter", "justificationRule", "color", "backgroundDisabledColor", "textShadowColor", "unfocusedTextSelectionColor", "paragraphSpaceBefore", "textIndent", "locale", "barColor", "textAlpha", "baselineShift", "fontThickness", "touchDelay", "textShadowAlpha", "renderingMode", "textJustify", "textRotation", "tabStops", "direction", "firstBaselineOffset", "lineThrough", "symbolColor", "focusedTextSelectionColor", "letterSpacing", "disabledColor", "alignmentBaseline", "labelPlacement", "trackingLeft", "modalTransparencyColor", "rollOverColor", "modalTransparencyBlur", "listStylePosition", "modalTransparencyDuration", "modalTransparency", "inactiveTextSelectionColor", "itemRollOverColor", "itemDisabledColor", "lineHeight", "leadingModel", "showErrorTip", "typographicCase"];
