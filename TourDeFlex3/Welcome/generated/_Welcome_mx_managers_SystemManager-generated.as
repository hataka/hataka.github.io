...
[ExcludeClass]
public class _Welcome_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _Welcome_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "Welcome" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "components", "containers", "core", "effects", "layout", "skins", "styles", "textLayout" ],
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "Welcome",
            mixins: [ "_Welcome_FlexInit", "_Welcome_Styles" ],
            paddingBottom: "0",
            paddingLeft: "0",
            paddingRight: "0",
            paddingTop: "0",
