...
[ExcludeClass]
public class _explorer_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _explorer_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "explorer" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "collections", "components", "containers", "controls", "core", "effects", "layout", "logging", "messaging", "rpc", "skins", "styles", "textLayout" ],
            creationComplete: "checkParameters()",
            currentDomain: ApplicationDomain.currentDomain,
            initialize: "init()",
            layout: "vertical",
            mainClassName: "explorer",
            mixins: [ "_explorer_FlexInit", "_explorer_Styles", "mx.messaging.config.LoaderConfig", "mx.managers.systemClasses.ActiveWindowManager" ],
            paddingBottom: "2",
            paddingLeft: "2",
            paddingRight: "2",
            paddingTop: "2",
