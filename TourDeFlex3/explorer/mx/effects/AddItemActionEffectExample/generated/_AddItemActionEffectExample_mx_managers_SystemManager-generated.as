...
[ExcludeClass]
public class _AddItemActionEffectExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _AddItemActionEffectExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "AddItemActionEffectExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "collections", "components", "containers", "core", "effects", "layout", "skins", "styles" ],
            currentDomain: ApplicationDomain.currentDomain,
            mainClassName: "AddItemActionEffectExample",
            mixins: [ "_AddItemActionEffectExample_FlexInit", "_AddItemActionEffectExample_Styles" ],
            paddingBottom: "0",
            paddingLeft: "0",
            paddingRight: "0",
            paddingTop: "0",
