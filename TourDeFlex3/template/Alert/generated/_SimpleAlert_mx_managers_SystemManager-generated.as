...
[ExcludeClass]
public class _SimpleAlert_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _SimpleAlert_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "SimpleAlert" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            mainClassName: "SimpleAlert",
            mixins: [ "_SimpleAlert_FlexInit", "_SimpleAlert_Styles", "mx.managers.systemClasses.ActiveWindowManager" ],
