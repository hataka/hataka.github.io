...
public class _BubbleChartExample_Styles
{
    ...
    public static function init(fbs:IFlexModuleFactory):void
    {
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.series.BubbleSeries", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.series.BubbleSeries");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
        ...
        conditions = null;
        conditions = null;
        selector = new CSSSelector("mx.charts.BubbleChart", conditions, selector);
        mergedStyle = styleManager.getMergedStyleDeclaration("mx.charts.BubbleChart");
        style = new CSSStyleDeclaration(selector, styleManager, mergedStyle == null);
