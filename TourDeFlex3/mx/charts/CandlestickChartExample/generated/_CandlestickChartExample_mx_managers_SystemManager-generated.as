...
[ExcludeClass]
public class _CandlestickChartExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _CandlestickChartExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "CandlestickChartExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            fontSize: "24",
            mainClassName: "CandlestickChartExample",
            mixins: [ "_CandlestickChartExample_FlexInit", "_CandlestickChartExample_Styles" ],
            paddingBottom: "0",
            paddingLeft: "0",
            paddingRight: "0",
            paddingTop: "0",
