...
[ExcludeClass]
public class _AccordionExample_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _AccordionExample_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "AccordionExample" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            fontSize: "24",
            fontWeight: "normal",
            mainClassName: "AccordionExample",
            mixins: [ "_AccordionExample_FlexInit", "_AccordionExample_Styles" ],
            paddingBottom: "0",
            paddingLeft: "0",
            paddingRight: "0",
            paddingTop: "0",
