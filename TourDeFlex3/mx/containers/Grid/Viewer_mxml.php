 ...
 *================================================================
 * title: flex3sdk mxml?????
 * file: GridLayoutExample.php
 * path: F:\Flash\flex3.4\mxml\TourDeFlex\GridLayoutExampleGridLayoutExample\pgp
 * url:  http://hata2/Flash/ApacheFlex/mx/containers/Grid/GridLayoutExample.php
 * created: Time-stamp: <2010-09-21 15:35:01 kahata>
 * revision: $Id$
 * Programmed By: kahata
 * To compile:F:\Flash\flex3.4\flex_sdk_3.4.0.9271_mpl\bin\mxmlc.exe GridLayoutExample.mxml
 * To run: 
 * link: 
 ...
 */
 ...
 //-----------?? -------------
	$source = isset($_GET['file']) ? $_GET['file'] : 'GridLayoutExample.mxml';
