 ...
 *================================================================
 * title: flex3sdk mxml?????
 * file: SimpleCanvasExample.php
 * path: F:\Flash\flex3.4\mxml\TourDeFlex\SimpleCanvasExampleSimpleCanvasExample\pgp
 * url:  http://hata2/Flash/ApacheFlex/mx/containers/Canvas/SimpleCanvasExample.php
 * created: Time-stamp: <2010-09-21 15:35:01 kahata>
 * revision: $Id$
 * Programmed By: kahata
 * To compile:F:\Flash\flex3.4\flex_sdk_3.4.0.9271_mpl\bin\mxmlc.exe SimpleCanvasExample.mxml
 * To run: 
 * link: 
 ...
 */
 ...
 //-----------?? -------------
	$source = isset($_GET['file']) ? $_GET['file'] : 'SimpleCanvasExample.mxml';
